      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-slate-500">
            Save and organize the web, privately.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-slate-700 font-medium border border-slate-200 hover:border-slate-300 rounded-xl px-4 py-3 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <svg
